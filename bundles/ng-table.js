...
var NgTableDefaultGetDataProvider = (function () {
    function NgTableDefaultGetDataProvider() {
        ...
        */
        ...
        function ngTableDefaultGetData($filter, $parse, ngTableEventsChannel) {
            ...
            function getOrderByFn(params) {
                return function (array, sortPredicate, reverseOrder, compareFn) {
                    ...
                    var predicates = processPredicates(sortPredicate), descending = reverseOrder ? -1 : 1, compare = ng1.isFunction(compareFn) === true ? compareFn : defaultCompare;
                    return Array.prototype.map.call(array, getComparisonObject).sort(doComparison).map(function (item) {
                        return item.value;
                    });
            ...
            function processPredicates(sortPredicates) {
                return sortPredicates.map(function (predicate) {
                    var descending = 1, get = ng1.identity;
            ...
            function defaultCompare(v1, v2) {
                var type1 = v1.type, type2 = v2.type;
                var result = 0;
                if (type1 === type2) {
            ...
            function isArrayLike(value) {
                ...
                var length = 'length' in Object(value) && value.length;
